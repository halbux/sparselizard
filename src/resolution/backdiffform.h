...
#ifndef BACKDIFFFORM_H
#define BACKDIFFFORM_H
...
class backdiffform
{
    private:
		...
		// The order for the Backward Differentition Formulations
		int order;
    ...
    public:
        ...
        backdiffform(formulation formul,int ordre, vec xinit, vec dtxinit, std::vector<bool> isrhskcconstant = {false, false, false});
