...
namespace myalgorithm
{
    ...
    void assignedgenumbers(std::vector<bool>& isowncell, std::vector<std::vector<double>>& cornercoords, std::vector<int>& edgenumbers, std::vector<bool>& isbarycenteronnode);
