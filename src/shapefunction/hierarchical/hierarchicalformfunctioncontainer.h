...
class hierarchicalformfunctioncontainer
{
	...
	private:
        ...
        //
        // - specific to order h+1 (i.e. order 1 is at index 0)
	...
	public:
		...
		int gethighestorder(void) { return val.size(); };
		...
		void set(int order, int i, int j, int k, int l, int n, polynomial& poly);
