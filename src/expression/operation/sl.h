...
namespace sl
{
    ...
    void mapdofs(std::shared_ptr<dofmanager> dm, std::vector<std::shared_ptr<rawfield>> rfs, std::vector<bool> isdimactive, bool excludedirichlet, std::vector<intdensematrix>& sendinds, std::vector<intdensematrix>& recvinds);
