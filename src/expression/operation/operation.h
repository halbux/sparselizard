...
class operation : public std::enable_shared_from_this<operation>
{
    ...
    public:
        ...
        virtual double getvalue(void) { throw std::logic_error("Statically called virtual method"); };
        ...
        virtual int getselectedrow(void) { throw std::logic_error("Statically called virtual method"); };
        virtual int getselectedcol(void) { throw std::logic_error("Statically called virtual method"); };
        ...
        virtual void removeterm([[maybe_unused]] int whichterm) {};
        // Count the number of sum or product terms:
        virtual int count(void) { throw std::logic_error("Statically called virtual method"); };
        ...
        virtual void reuseit([[maybe_unused]] bool istobereused) {};
        ...
        virtual int getphysicalregion(void) { throw std::logic_error("Statically called virtual method"); };
        virtual int getspacederivative(void) { throw std::logic_error("Statically called virtual method"); };
        virtual int gettimederivative(void) { throw std::logic_error("Statically called virtual method"); };
        virtual int getkietaphiderivative(void) { throw std::logic_error("Statically called virtual method"); };

        // Get the 'argnum'th argument:
        virtual std::shared_ptr<operation> getargument([[maybe_unused]] int argnum)
        {
            throw std::logic_error("Statically called virtual method");
        }
        // Replace the 'argnum'th argument:
        virtual void replaceargument([[maybe_unused]] int argnum,
                                     [[maybe_unused]] std::shared_ptr<operation> newarg) {};

        // Get the form function component number used in the field, dof or tf:
        virtual int getformfunctioncomponent(void) { throw std::logic_error("Statically called virtual method"); };
        // Know which subfield of the original field it was:
        virtual int getfieldcomponent(void) { throw std::logic_error("Statically called virtual method"); };
        ...
        virtual std::shared_ptr<operation> copy(void) { throw std::logic_error("Statically called virtual method"); };
        ...
        virtual std::shared_ptr<operation> simplify([[maybe_unused]] std::vector<int> disjregs)
        {
            return shared_from_this();
        };

        // Evaluate an operation that only contains x, y and/or z fields without derivatives.
        virtual std::vector<double> evaluate(std::vector<double>& xcoords,
                                             std::vector<double>& ycoords,
                                             std::vector<double>& zcoords);

        // For dof interpolation:
        virtual bool ison(void) { throw std::logic_error("Statically called virtual method"); };
        virtual void setoncontext([[maybe_unused]] oncontext& cntxt) {};
        virtual oncontext* getoncontext(void) { throw std::logic_error("Statically called virtual method"); }
};
