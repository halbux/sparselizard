...
// around that static deflection for a bilayer disk whose top layer is prestressed, whose bottom layer
// is clamped at its external boundary and on top of which the atmosperic pressure pushes.
