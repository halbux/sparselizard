...
// The silicon and PZT crystal is rotated to align to a given (arbitrary) orientation.
...
{	
    ...
    // Rotate the Silicon and PZT cristal first by -30 degrees around y then by 45 degrees around z.
