...
{   
    ...
    // The high-temperature superconductor is defined by its power-law exponent n, 
    // its critical electric field Ec [V/m] and critical current density Jc [A/m^2]:
    double n = 30.0, Ec = 1e-4, Jc = 1e8;
    
    // The conductivity follows a power law (1e-11 is added to never divide by 0):
    ...
    // Write to text file the field at the tube center for all timesteps:
