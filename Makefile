...
INCL = -I ~/SLlibs/petsc/include/ -I ~/SLlibs/petsc/arch-linux2-c-opt/include/ -I ~/SLlibs/fftw/install/include -I ~/SLlibs/slepc/include -I ~/SLlibs/slepc/arch-linux2-c-opt/include
endif
ifeq ($(UNAME), Darwin)
...
INCL = -I ~/SLlibs/petsc/include/ -I ~/SLlibs/petsc/arch-darwin-c-opt/include/ -I ~/SLlibs/fftw/install/include -I ~/SLlibs/slepc/include -I ~/SLlibs/slepc/arch-darwin-c-opt/include
endif
